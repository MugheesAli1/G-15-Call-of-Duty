...
public class G15_L3_SajidMachine : MonoBehaviour
{//work jiii ////
...
//    bool IsMovementStoped = true;
    ...
    private void InitializeMachine()
    {
        ...
        string input = symbol.ToString() + inputText + symbol.ToString() + symbol.ToString() + symbol.ToString();
    ...
    public bool GetNextState()
    {
        ...
        switch (CurrentState)
        {
            case "q1":
                ...
                {
                    case 'a':
                        PerformTransaction('w', Movement.R, "q2");
                        break;

                    case 'x':
                        PerformTransaction('x', Movement.R, "q7");
                        break;

                    default:
                        HideRejectedImageWork.gameObject.SetActive(true);
                        UpdateHeadDisplay(Color.red, "Reject");
            ...
            case "q2":
                switch (getCurrentChar())
                {
                    ...
                    case 'b':
                        PerformTransaction('x', Movement.R, "q3");
                        break;
            ...
            case "q4":
                ...
                {
                    case 'a':
                        PerformTransaction('a', Movement.R, "q4");
                        break;

                    case 'z':
                        PerformTransaction('z', Movement.R, "q4");
                        break;
                    case 'b':
                        PerformTransaction('z', Movement.R, "q5");
                        break;
            ...
            case "q5":
                ...
                {
                    case 'b':
                        PerformTransaction('z', Movement.L, "q6");
                        break;
            ...
            case "q6":
                switch (getCurrentChar())
                {
                    ...
                    case 'a':
                        PerformTransaction('a', Movement.L, "q6");
                        break;

                    case 'x':
                        PerformTransaction('x', Movement.L, "q6");
                        break;
                    ...
                    case 'w':
                        PerformTransaction('w', Movement.R, "q1");
                        break;
                    default:
                        HideRejectedImageWork.gameObject.SetActive(true);
                        UpdateHeadDisplay(Color.red, "Reject");
            ...
            case "q7":
                switch (getCurrentChar())
                {
                    ...
                    case 'y':
                        PerformTransaction('y', Movement.R, "q8");
                        break;
            ...
            case "q8":
                switch (getCurrentChar())
                {
                    ...
                    case 'z':
                        PerformTransaction('z', Movement.R, "q9");
                        break;
            ...
            case "q9":
                switch (getCurrentChar())
                {
                    ...
                    case '#':
                        PerformTransaction('#', Movement.H, "q10");
                        break;
            ...
            case "q10":
                ...
                getCurrentChar();
                UpdateHeadDisplay(Color.green, "Accept");
                SpaceButtonMusic.Stop();
                AcceptedMusic.Play();
