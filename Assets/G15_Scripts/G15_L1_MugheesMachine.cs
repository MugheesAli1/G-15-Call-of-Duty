...
public class G15_L1_MugheesMachine : MonoBehaviour
{//work jiii ////===@c
...
//    bool IsMovementStoped = true;
    ...
    private void InitializeMachine()
    {
        ...
        string input = symbol.ToString() + inputText + symbol.ToString() + symbol.ToString() + symbol.ToString() + symbol.ToString();
        Word = ConvertToCharList(input);
        CreateMachine(Word);

        CurrentStateText.GetComponent<TextMesh>().text = "State: " + CurrentState;
    }
        ...
        switch (CurrentState)
        {
            case "q1":
                switch (getCurrentChar())
                {
                    ...
                    case 'y':
                        PerformTransaction('y', Movement.R, "q6");
                        break;
            ...
            case "q4":
                ...
                {
                    case 'a':
                        PerformTransaction('z', Movement.L, "q5");
                        break;
                    case 'z':
            ...
            case "q5":
                switch (getCurrentChar())
                {
                    ...
                    case 'a':
                        PerformTransaction('a', Movement.L, "q5");
                        break;
            ...
            case "q6":
                switch (getCurrentChar())
                {
                    ...
                    case 'z':
                        PerformTransaction('z', Movement.R, "q7");
                        break;
